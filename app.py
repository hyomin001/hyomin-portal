...
FORGE_DATA = {
    ...
    15: {"rate": 0.00001, "cost": 0, "sell": 500_000_000_000_000, "name": "👑 [신화] 엑스칼리버 +15", "color": "#FFFFFF"} # 만렙
}
...
# =====================================================================
    ...
    def check_quest(qid):
        if qid == "attendance": 
            ...
            return any(v > 0 for v in st.session_state.real_estate.values())
        elif qid == "debtfree": 
            return st.session_state.loan == 0
        elif qid == "investor":
            return sum(
