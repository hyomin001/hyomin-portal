...
def render(market, nw):
    ...
    st.markdown("<div style='color:#B0BAC8;margin-bottom:16px;'>다른 시민들과 은밀하게 작전을 모의하거나 흥정하세요. 시스템은 여러분의 대화를 엿듣지 않습니다. (아마도요)</div>", unsafe_allow_html=True)
            ...
            for m in reversed(inbox[-50:]): 
                ...
                <div class='card' style='padding:14px 18px; margin:8px 0; border-left:4px solid #00E5FF;'>
                  <div style='display:flex;justify-content:space-between;margin-bottom:8px;'>
                    ...
                    <span style='color:#B0BAC8;font-size:0.75rem;'>{m.get('time', '')}</span>
                  </div>
