...
def get_pet_sprite(species_id, lv):
    """profile.py 호환용 — 단계별 대표 이모지 반환"""
    stage = get_pet_stage(lv)
    emoji_map = {
        "dragon":  {"egg":"🥚","baby":"🐉","adult":"🐲","legend":"🌌"},
        "wolf":    {"egg":"🥚","baby":"🐺","adult":"🦊","legend":"⭐"},
        "penguin": {"egg":"🥚","baby":"🐧","adult":"🐧","legend":"👑"},
        "cat":     {"egg":"🥚","baby":"🐱","adult":"🐈","legend":"🍀"},
        "unicorn": {"egg":"🥚","baby":"🦄","adult":"🦄","legend":"🌈"},
        "phoenix": {"egg":"🔥","baby":"🐦","adult":"🦅","legend":"🌟"},
        "slime":   {"egg":"🟡","baby":"🫧","adult":"💛","legend":"💰"},
        "fox":     {"egg":"🥚","baby":"🦊","adult":"🦊","legend":"🌙"},
    }
    return emoji_map.get(species_id, {"egg":"🥚","baby":"🐾","adult":"🐾","legend":"⭐"}).get(stage, "🐾")
